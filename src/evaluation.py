...
def simular_estrategia_investimento(
    ...
    if not df_resultado.empty:
        ...
        df_resultado = pd.DataFrame({"CapitalFinal": [capital], "RetornoPercentual": [0.0]})
...
def comparar_modelos_regressao(
    ...
    lucro_linear, sim_linear = simular_estrategia_investimento(df, pred_linear, verbose=False)
    resultados['Linear'] = {
    ...
    for grau in range(2, 11):
        ...
        lucro_poly, sim_poly = simular_estrategia_investimento(df, pred_poly, verbose=False)
